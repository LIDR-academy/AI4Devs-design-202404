Chat link: https://chat.openai.com/share/ddb35f20-8f54-40bc-bb74-c9b9b88db55c

User
Eres un expreto en Management de Software, te entregan el siguiente documento de diseño de producto de un sistema de ATS (Applicant-Tracking System):
```md
...
Con base en este documento de diseño genera 2 User Stories del proyecto.

User
Ahora arma el Backlog de producto con las User Stories. Estima por cada item en el backlog (genera una tabla markdown):
